  ...
  const register = async (e) => {
    ...
    try {
      ...
      if (res.ok && data.message === "Registered successfully") {
        ...
        Swal.fire("Weak Password", "Password should be at least 8 characters long.", "error");
      } else {
        Swal.fire("Error", data.message || "Something went wrong. Please try again later.", "error");
      }
    } catch (err) {
